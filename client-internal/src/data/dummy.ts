...
export const staffMembers: StaffMember[] = [
  {
    ...
    status: 'active',
    bio: 'Dokter hewan umum dengan fokus pada pemeriksaan preventif, tindakan bedah minor, dan monitoring pasien pasca operasi.',
    schedule: 'Senin-Jumat, 09:00-16:00',
    room: 'Ruang Praktik 1',
    licenseNumber: 'STRV-2026-0018',
    education: 'DVM, Universitas Airlangga',
    experience: '8 tahun pengalaman klinik hewan kecil',
    services: ['General Checkup', 'Vaccination', 'Dental Scaling', 'Surgery Follow-up', 'Wound Care'],
    certifications: ['Small Animal Surgery', 'Preventive Care', 'Dental Prophylaxis'],
    image:
  ...
  },
  {
    ...
    status: 'active',
    bio: 'Dokter ortopedi yang menangani konsultasi mobilitas, evaluasi cedera, dan rencana rehabilitasi hewan peliharaan.',
    schedule: 'Selasa-Sabtu, 10:00-17:00',
    room: 'Ruang Praktik 2',
    licenseNumber: 'STRV-2026-0024',
    education: 'DVM, IPB University',
    experience: '6 tahun pengalaman ortopedi hewan kecil',
    services: ['Orthopedic Consultation', 'Lameness Evaluation', 'Post-op Mobility Review', 'Pain Management'],
    certifications: ['Small Animal Orthopedics', 'Rehabilitation Planning'],
    image:
  ...
  },
  {
    ...
    status: 'active',
    bio: 'Resepsionis yang mengatur antrean, komunikasi pemilik hewan, dan verifikasi administrasi layanan.',
    schedule: 'Senin-Jumat, 08:00-16:00',
    room: 'Front Desk',
    education: 'Clinic Administration Certificate',
    experience: '4 tahun pengalaman operasional klinik',
    image:
